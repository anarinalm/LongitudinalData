...
\textbf{How would our interpretation change after adding an interaction term?}
...
\textbf{How would this change if an interaction term was included in the model?}
